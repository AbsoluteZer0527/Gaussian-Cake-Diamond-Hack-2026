...
// 1. Force enable point size so the Vertex Shader can control it
glEnable(GL_PROGRAM_POINT_SIZE);

// 2. Set Uniforms
glUniformMatrix4fv(glGetUniformLocation(particleShader, "uViewProj"), 1, GL_FALSE, glm::value_ptr(viewProjection));
